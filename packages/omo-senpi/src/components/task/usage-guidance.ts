...
export const TASK_USAGE_GUIDANCE = [
  ...
  "- /tasks shows this session's children; task_output is for one midpoint status or transcript peek (mode:\"tail\" for recent output); task_send({ deliver_as:\"interrupt\" }) parks one, while task_cancel ends it.",
