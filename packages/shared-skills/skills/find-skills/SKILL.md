...
Do not recommend a skill based only on search results. Always verify:

1. Install count - Prefer skills with 1K+ installs. Be cautious with anything under 100.
2. Source reputation - Official sources such as `vercel-labs`, `anthropics`, and `microsoft` are more trustworthy than unknown authors.
3. GitHub stars - Check the source repository. A skill from a repo with under 100 stars should be treated with skepticism.
...
- Search by domain and task, not just a broad category.
- Prefer established publishers and skills with clear documentation.
- Install only after the user approves adding a new skill.
