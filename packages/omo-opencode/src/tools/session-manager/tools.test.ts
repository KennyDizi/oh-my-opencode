...
function createSessionManagerTools(mockCtx: PluginInput, arg1: { setStorageClient: () => void; getMainSessions: () => Promise<SessionMetadata[]>; filterSessionsByDate: (sessionIDs: any) => Promise<any>; formatSessionList: (sessionIDs: any) => Promise<string>; sessionExists: (sessionID: any) => Promise<boolean>; readSessionMessages: (sessionID: any) => Promise<SessionMessage[]>; readSessionTodos: () => Promise<TodoItem[]>; formatSessionMessages: (messages: any) => string; getAllSessions: () => Promise<string[]>; searchInSession: (sessionID: any) => Promise<SearchResult[]>; formatSearchResults: (results: any) => string; getSessionInfo: (sessionID: any) => Promise<SessionInfo | null>; formatSessionInfo: (info: any) => string }) {
