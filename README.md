...
- **Agents**: Sisyphus (the main agent), Prometheus (planner), Oracle/Fato (architecture and review), Librarian (docs/code search), Explore (fast codebase grep), Multimodal Looker, Praha (technical document clarity review)
